        ...
        <div>
            ...
            >
                {panel.image !== '' ?? panel.image !== undefined ? (
                    <>
                        <Tooltip label="Panel Image - Click to copy link" width={200} position="top" wrapLines>
                            <Image
                                src={panel.image}
                                alt={panel.title}
                                width={320}
                ...
                <Tooltip label="Panel Title" position="left">
                    <h1>{panel.title}</h1>
                </Tooltip>

                <hr />

                <Tooltip label="Panel Description (markdown) - Click to copy to clipboard" width={200} position="left" wrapLines>
                    <div
                        onClick={() => {
                ...
                {panel.link !== '' ?? panel.link !== undefined ? (
                    <Text size="sm">
                        Image links to:{' '}
                        <Tooltip label="Click to copy link" position="left">
                            <Text
                                onClick={() => {
                ...
                <Text size="sm">
                    ...
                    <Text
                        ...
                        inherit
                        style={{
                            backgroundColor: panel.status === 'ACCEPTED' ? 'green' : panel.status === 'PENDING' ? 'grey' : 'red',
                        }}
                        color="white"
                    >
                        {panel.status}
