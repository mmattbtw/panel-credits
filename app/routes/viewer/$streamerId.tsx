...
export default function StreamerPage() {
    ...
    return (
        <Container>
            <Group>
                <Button component={Link} to="/viewer" prefetch="intent" color="gray" my={'1rem'}>
                    Back to dashboard
                </Button>
            </Group>
            ...
            <Button component={Link} to={`/viewer/${creditProfile.streamerId}/submitpanel`} prefetch="intent">
                Submit a new panel
            </Button>
            ...
            {panels.length >= 1 ? panels.map((panel) => <PanelComponent key={panel.id} {...panel} />) : <p>You have not submitted any panels yet!</p>}
        </Container>
    );
}
